...
import com.example.islamiccallscreen.databinding.FragmentWallpaperBinding;
...
public class WallpaperFragment extends BaseFragment<FragmentWallpaperBinding>{
    ...
    @Override
    public FragmentWallpaperBinding setBinding(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        return null;
    }
